...
public partial class MainPage : ContentPage
{
    ...
    {
        // var email = "example4579@gmail.com"; // Must be unique for each run
        // var password = "password";
        // var userId = "b1c1f27a-cc59-4d2b-ae74-7b3b0e33a61a";
        // var vaultId = "adef17a9-ab47-4c27-832c-75ed590ac663";
        // List<string> secrets = [];
        ...
        // 3. If vault exists on server, compare nonce, if different, upload local vault to server + if vaults do not exist on server, upload local vault to server
